...
(use-package go-mode
  :init
  ;; eglot-ensure is registered globally for go-mode in the LSP section.
  ;; Keep yas-minor-mode and before-save formatting hooks.
...
(use-package rustic
  ...
  :bind (:map rustic-mode-map
              ...
              ("C-c C-c s" . eglot-list-connections))
  :config
