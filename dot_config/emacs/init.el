...
;; NOTE: Ellama package not available in standard repos yet
;; Commented out to prevent startup errors
;; Alternative: Use gptel with Ollama or wait for ellama MELPA inclusion
...
;; GPTel configuration (API-based AI - optional, Ellama is the default)
;; (use-package gptel
;;   :defer t
;;   :config
;;   ;; SECURITY: Store API key in ~/.authinfo.gpg with this line:
